...
$(function() {
  ...
  $("#default").on("click", function() {
    $("link[data-style='true']").attr("href", "/dist/css/default.build.css");
  });

  $("#style1").on("click", function() {
    $("link[data-style='true']").attr(
      "href",
      "/dist/css/orangeStyle.build.css"
    );
  });
  ...
  $wn.scroll(function() {
    $(".timeline__bullet").each(function() {
      ...
      if (
        ...
        parseInt(that.offset().top) - timeLineScale
      ) {
        if (!that.hasClass("wiggle")) {
          that
            .addClass("wiggle")
            .find(".card-custom")
            .addClass("active")
