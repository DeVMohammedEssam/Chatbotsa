...
class AllHtml extends Component {
  state = {};
  componentDidMount() {
                    ...
                    <div className="col-12 col-md-5">
                      ...
                      <ul>
                        ...
                        <p className="service__desciption">
                          {" "}
                          Lorem ipsum, dolor sit amet consectetur adipisicing
                          elit. Perspiciatis cupiditate veritatis aut. Nobis
                          modi maiores, omnis vero doloribus in pariatur
                          perspiciatis odit dolorum illum corrupti harum
                          expedita provident sit natus quod deserunt blanditiis
                          ducimus? Dicta, exercitationem! Provident beatae
                          doloremque nobis.
                        </p>
                      </ul>
                    </div>
          ...
          <div className="row text-center">
            <div className="col-12 col-lg-5 blogs-title__container">
              ...
              <p className="blogs__text">
                ...
                provident, praesentium voluptate molestiae molestias dolorum
                ipsam ea veritatis. Asperiores magni maiores perferendis facilis
            ...
            <div className="col-xs-12 col-md-4 my-5 my-lg-2" id="hiring">
              ...
              <div className="when-hiring-hidden">
                ...
                <div className="col-12">
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Consequatur necessitatibus assumenda inventore error,
                    dolores quibusdam dolore nam consequuntur asperiores
                    pariatur.
                  </p>
                </div>
              </div>
